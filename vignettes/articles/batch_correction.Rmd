...
Here we present an example dataset that is combined from "pbmc6k" and "pbmc8k", originally available from package [TENxPBMCData](https://bioconductor.org/packages/release/data/experiment/html/TENxPBMCData.html), which you can import by a function called `importExampleData()`.
```{r import}
